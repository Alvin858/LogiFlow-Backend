...
namespace LogiFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260911045020_Final")]
    partial class Final
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.Route", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.Payment", b =>
                {
                    b.HasOne("LogiFlow.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("LogiFlow.Domain.Entities.RouteStop", b =>
                {
                    b.HasOne("LogiFlow.Domain.Entities.Route", "Route")
                        .WithMany("RouteStops")
